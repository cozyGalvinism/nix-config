...
let
  ...
  commonExtensions = [ openvsx.kylinideteam.gitlens ];
  commonSettings = {
  ...
  profileBaseSettings = {
    rust = commonSettings // { "editor.formatOnSave" = true; };
  ...
  profileSecretInjections = [
    {
      ...
      items = [
        {
          key = "codestats.apikey";
          secret = "codestats.apikey";
        }
        {
          key = "wakatime.apiKey";
          secret = "wakatime.apikey";
        }
      ];
    }
    {
...
in {
  age.secrets = {
    "codestats.apikey" = { file = ../secrets/codestats.apikey.age; };
    "wakatime.apikey" = { file = ../secrets/wakatime.apikey.age; };
  };
  ...
  programs.vscode = {
    ...
    profiles = {
      default =
        mkProfile { extraAttrs = { enableExtensionUpdateCheck = true; }; };
  ...
  home.activation.bootstrapXDG = lib.hm.dag.entryBefore [ "writeBoundary" ] ''
  ...
  home.activation.seedWindsurfProfiles =
    lib.hm.dag.entryAfter [ "bootstrapXDG" ] ''
          set -eu
  ...
  home.activation.injectWindsurfSecrets =
    lib.hm.dag.entryAfter [ "seedWindsurfProfiles" ] (let
      mkSnippet = inj:
        ''
                  profiles_dir="$HOME/.config/Windsurf/User/profiles"
